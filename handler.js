        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              this.sendButtonImg(jid, action === 'add' ? wel.toBuffer() : lea.toBuffer(), text, action === 'add' ? 'Welcome Message' : 'Leave Message', action === 'add' ? 'Welcome Kak ^_^' : 'Yahh kok out sihh :(',action === 'add' ? 'Welcome Kak ^_^' : 'Yahh kok out sihh :(', {
key: {
fromMe: false,
...
global.dfail = (type, m, conn) => {
  ...
  let botAdmin = {
    botAdmin: '*BOT NYA BUKAN ADMIN KAK ^_^*',
  }[type]
